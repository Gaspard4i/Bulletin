    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Semestre en cours</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">0</div>
          <p className="text-xs text-muted-foreground">Notes à venir</p>
        </CardContent>
      </Card>
    </div>
  );
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">0</div>
          <p className="text-xs text-muted-foreground">Évaluations en attente</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          <div className="text-2xl font-bold">0</div>
          <p className="text-xs text-muted-foreground">Dans vos matières</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
...
export function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {user?.role === Role.SCOLARITE && <ScolariteDashboard />}
